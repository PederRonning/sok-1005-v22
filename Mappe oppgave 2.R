...
# Den tilpassede linjen viser en tydelig sammenheng mellom den prosentvise vaksinerte andelen av befolkningen og månedlige dødsfall per 100 000.
# Antall dødsfall synker samtidig som den prosentvise andelen vaksinerte øker.
